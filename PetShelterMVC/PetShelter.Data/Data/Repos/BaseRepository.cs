...
namespace PetShelter.Data.Data.Repos
{
	...
	where TModel : BaseModel
	{
		...
		public async Task<IEnumerable<TModel>> GetTaskAsync()
		{
		...
		public async SaveAsync(TModel model)
		{
			if (model == null)
			{
				throw new ArgumentNullException(nameof(model))
